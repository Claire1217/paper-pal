...
- An animated picture of the review loop at the top of the READMEs
  (`docs/images/flow-light.svg`, `flow-dark.svg`), generated by
  `npm run animation`. The overview screenshot moves under "What it is".
